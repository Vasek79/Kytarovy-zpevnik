...
\refren{
\Ami O vodě, \X o trávě, \Dmi o lese,\hspace{1em}\X\\
\GSedm o smrti, \X se kterou smířit \C nejde se,\hspace{1em}\X\\
\Ami o lásce, \X o zradě, \Dmi o světě\hspace{1em}\X\\
\ESedm a o všech lidech, co \X kdy žili na téhle \Ami planetě.\hspace{1em}\X
}
